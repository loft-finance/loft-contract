...
module.exports = async ({ getNamedAccounts, deployments, getChainId }) => {
  ...
  // accounts 'OfUSD', 'xAUD', 'xEUR' balanceof
  ...
  await execute("Exchanger", { from: deployer }, "setExchangeEnabled", true);

  // account1 exchange xAUD
  // account1 buy xAUD to OfUSD
  // const value = await read('xAUD', {}, 'balanceOf', account4);
  // console.log(value.toString());
  // // if (Number(value.toString()) <= 0) {
  // console.log(account4, toBytes32('OfUSD'),
  //   toUnit(2).toString(),
  //   toBytes32('xAUD'));
