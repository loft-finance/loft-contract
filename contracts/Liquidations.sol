    ...
    AddressResolverUpgradeable
{
    ...
    function isOpenForLiquidation(address account)
        ...
        returns (bool)
    {
        uint256 accountCollateralisationRatio = synthesizer()
    ...
    function calculateAmountToFixCollateral(
        ...
        uint256 divisor = unit.sub(
            unit.add(liquidationPenalty).multiplyDecimal(ratio)
        );
        ...
        rateNotStale("LOFT")
    {
        ...
        uint256 accountsCollateralisationRatio = synthesizer()
            .collateralisationRatio(account);
